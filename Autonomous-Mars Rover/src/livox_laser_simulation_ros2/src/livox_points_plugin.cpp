...
namespace gazebo
{
    ...
    void LivoxPointsPlugin::Load(gazebo::sensors::SensorPtr _parent, sdf::ElementPtr sdf)
    {
        ...
        sdfPtr = sdf;
        auto sensorElem = sdfPtr->GetParent();
        auto rayElem = sensorElem->GetElement("ray");
        ...
        RayPlugin::Load(_parent, sensorElem);
    ...
    void LivoxPointsPlugin::OnNewLaserScans()
{
    ...
    if (rayShape)
    {
        ...
        pp_livox.header.frame_id = parent_name;
        int count = 0;
        ...
        cloud.header.frame_id = parent_name;
